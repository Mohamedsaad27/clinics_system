                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="national_id" name="national_id"
                            value="{{ old('national_id', $patient->national_id) }}" required>
                        @error('national_id')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="city" name="city"
                            value="{{ old('city', $patient->userAddresses->first()->city ) }}" required>
                        @error('city')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="country" name="country"
                            value="{{ old('country', $patient->userAddresses->first()->country) }}" required>
                        @error('country')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
